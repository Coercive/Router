...
class Router {
    ...
    private function _parseRouteParams($sPath) {
        ...
        if(!preg_match_all(self::REGEX_PARAM, $this->_sCurrentPreparedRoot, $aMatches, PREG_OFFSET_CAPTURE | PREG_SET_ORDER)) {
            return $aParams;
        }
        ...
        foreach ($aMatches as $iKey => $aSet) {
            ...
            $this->_sCurrentPreparedRoot = str_replace($aSet[0][0], "#$iKey#", $this->_sCurrentPreparedRoot);
        }
